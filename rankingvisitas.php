...
<!--        <meta http-equiv="refresh" content="5">-->
    ...
    <body>
        <nav>
            <div id="menu">
                    <div id="link-1"><a href="#">Home</a></div>
                    <div id="link-2"><a href="#">Jesuita</a></div>
                    <div id="link-3"><a href="#">Lugares</a></div>
                ...
                if(session_id()) {
                    echo '<div id="link-4"><a href="#">Administracion</a></div>'; //se veria solo cuando entre el administrador.
                }
                ?>
            </div>
            <div id="autenticacion">
                <div id="contenido">
                    <div id="link-1"><a href="login.html">Iniciar Sesion</a></div>
                </div>
            </div>
        </nav>
    <div id="general">
